...
**Languages**  
TypeScript, JavaScript, Java, Python, C++, SQL, HTML, CSS, SCSS

**Frontend & Mobile**  
React, React Native, Redux, React Query, Angular, Material UI, D3.js, RxJS

**Backend & Cloud**  
Node.js, Express, REST APIs, GraphQL, Azure, Firebase

**Tooling & Testing**  
Git, GitHub Actions, CI/CD, Jest, React Testing Library, Selenium, Figma, Jira

- 🔭 I’m currently working on building and improving full-stack and mobile applications, with a focus on real-time systems.
- 🌱 I’m currently learning more about scalable system design, GraphQL, and performance optimization.
- 👯 I’m looking to collaborate on web, mobile, or real-time application projects.
- 🤔 I’m looking for help with understanding and building multiplayer mechanics — currently struggling with implementing multiplayer logic for Gwent from The Witcher 3.
- 📫 How to reach me: **dush.gowda@gmail.com**
---

📫 **GitHub:** https://github.com/SOM3-1  
